...
Catalog v1.14.0. Portal only. Not branded XXX. Adult shelf is gated and labeled Adult (includes Adult Swim plus a public AdultIPTV.net HTTPS list). All ages / Kids / 18+ gated shelves. Channel tab is steward rooms. v1.11 adds PBS/BBC sources, Free-TV country lists, Tubi/Distro/Vizio/Rakuten/LG/Plex-all FAST (jmp2.uk-majority packs skipped), more iptv-org regions/langs/countries. Steward rules: `CATALOG.md`.
